...
public class MyFTPClient {
    ...
    public boolean ftpChangeDirectory(String directory_path)
    {
        try {
            ...
            if (returnCode == 550) {
                ftpMakeDirectory(directory_path);
                mFTPClient.changeWorkingDirectory(directory_path);
            }
        } catch(Exception e) {
                             ...
                             String desDirectory)
    {
        ...
        try {
            ...
            Log.e("before file","reached");
            File f = new File(srcFilePath);
            FileInputStream srcFileStream = new FileInputStream(f);
            //FileInputStream srcFileStream = new FileInputStream(srcFilePath);//context.openFileInput(srcFilePath);

            Log.e("after file","reached");
